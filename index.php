...
//     }
/*********************************************
||| null if any existing spl function available
 ********************************************/
...
function libsLoader($class)
{
    ...
    if(!file_exists($folder))
    {
        ...
        print '<p style="text-align:center; font: 16px/25px normal Helvetica, Arial, sans-serif; color:red;">Files or <b>' .$fileName. '</b> Not Here! Look Like file Gone For Walk</p><br>';
        exit();
    }
    include_once $folder;
}
